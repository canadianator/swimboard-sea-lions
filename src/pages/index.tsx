    ...
    <>
      <PageContainer id="controller">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'left' }}>
          ...
          <div>
            Use the buttons below to update the counts. You can also use the left and right arrow keys. <br />
            ...
            <br />This is meant to work with a power point clicker: <br />
            <br />
            ...
            <div>
              <table width={"100%"}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td colSpan={2}>
                      <ControllerButton onClick={() => {controllerCounter?.decrementCount(CounterKeys.Bullpen); controllerCounter?.decrementCount(CounterKeys.RaceNumber); }}>Subtract both</ControllerButton>
                      <ControllerButton onClick={() => {controllerCounter?.incrementCount(CounterKeys.Bullpen); controllerCounter?.incrementCount(CounterKeys.RaceNumber); }}>Add both</ControllerButton>
                    </td>
                  </tr>
                </tbody>
              </table>
